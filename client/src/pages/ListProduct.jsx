...
const ListProduct = () => {
  ...
  return (
    <div className="w-full min-h-screen px-10 bg-zinc-100 flex flex-col justify-center items-center">
      <div className="w-full pt-10 font-bold text-4xl mb-5">List Products</div>
      {/* TABLE */}
      <div className="overflow-scroll w-[310px]  h-max-[700px] md:w-full xl:overflow-hidden lg:flex lg:justify-center">
        <table>
